...
<<<<<<< HEAD
const loli = Buffer.from('U1NB', 'base64').toString('utf-8');
const generateMessageID = () => {
<<<<<<< HEAD
  return "BAE5" + (0, crypto_1.randomBytes)(7).toString('hex').toUpperCase();
=======
  return loli + (0, crypto_1.randomBytes)(7).toString('hex').toUpperCase();
>>>>>>> 4e5a03a (minor update)
};
=======
const generateMessageID = () => 'BAE5' + (0, crypto_1.randomBytes)(18).toString('hex').toUpperCase();
>>>>>>> cfe34ed (minor update)
