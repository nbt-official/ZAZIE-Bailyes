...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
        ...
        m.messageContextInfo = {
        	messageAddOnDurationInSecs: message.pin.type === 1 ? message.pin.time : 86400
        }
        m.pinInChatMessage = {
            key: message.pin.key, 
            type: message.pin.type ? 2 : 1,
         ...
         m.scheduledCallCreationMessage = {
            ...
            callType: message.call.type ? 2 : 1, 
       ...
       m.eventMessage = {
          isCanceled: message.event.cancel ? true : false, 
          name: message.event.name,
          description: message.event.description,            
          joinLink: message.event.joinLink ? message.event.joinLink : 'https://call.whatsapp.com/voice/VFnmoNASaBMCTL7ATPReu2',
          startTime: message.event.startTime ? message.event.startTime : Math.floor(futureDate.getTime() / 1000)
       }
   }
